...
static const char *defaulttagapps[] = { "st", "firefox", "pycharm", "darktable", "open-lf", "open-mutt", "gimp", "slack", "discord" };
...
static Key keys[] = {
	...
	{ 0,                            XF86XK_MonBrightnessDown,   spawn,  SHCMD("sb-brightness down; kill -45 $(pidof dwmblocks)") },
	{ 0,                            XF86XK_MonBrightnessUp,     spawn,	SHCMD("sb-brightness up; kill -45 $(pidof dwmblocks)") },
